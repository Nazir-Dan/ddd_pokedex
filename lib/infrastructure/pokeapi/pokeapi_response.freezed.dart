...
mixin _$PokemonListResponse {
  ...
  List<PokemonListObjectDto> get results => throw _privateConstructorUsedError;
...
abstract class $PokemonListResponseCopyWith<$Res> {
  ...
  $Res call(
      ...
      String? next,
      String? previous,
      List<PokemonListObjectDto> results});
}
...
class _$PokemonListResponseImpl implements _PokemonListResponse {
  const _$PokemonListResponseImpl(
      ...
      required final List<PokemonListObjectDto> results})
      : _results = results;
  ...
  final List<PokemonListObjectDto> _results;
  @override
  List<PokemonListObjectDto> get results {
